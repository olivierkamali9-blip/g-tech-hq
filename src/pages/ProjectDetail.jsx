...
export default function ProjectDetail() {
  ...
  return (
    <div className="h-full flex">
      {/* Chat */}
      <div className="flex-1 flex flex-col min-w-0 border-r border-[color:var(--color-line)]">
        <div className="px-8 py-5 border-b border-[color:var(--color-line)]">
      ...
      {/* Aperçu */}
      <div className="w-80 shrink-0 px-6 py-6">
